package com.jetapptech.InAlpha.presentation.view.material.bottomBar
...
import com.jetapptech.InAlpha.presentation.ui.theme.customWhite3

@Composable
fun BottomBar(
    selectedItem : String = Screens.HomeScreen().name,
    onClick      : (String)->Unit = {},
